    ...
    <div className="projects">
      <div className="projects1">
        ...
        <div className="projects2">
          <h2 className="h2-projects2">Solo Projects</h2>
          <div className="div-squish">
            <p className="p-projects">
              ...
              <img className="picsquish" src={Sportflix} alt="Sportflix" />
            </p>
            ...
            <p className="p-projects">
              ...
              this to have more practice on javascript. I plan to add autoplay
              as a second player
              <br />
              <a
                className="aa"
        ...
        <div className="projects2">
          <h2 className="h2-projects2">group Projects</h2>
          ...
          onMouseLeave={() => setShowText(false)} */}
            ...
            <p className="p-projects">
              <b>
                ...
                thought about using phaser3 instead of p5, but finally we
                decided to use p5. But that was good as I learnt phaser3 too. I
                worked on some part of frontend, backend, git and wrote tests
                for some pages.
              </b>
              <a
                className="aa"
            ...
            {/* <div className="div-squish"> */}
            <p className="p-projects">
              This website was a one-day group project. It is a game created
              using React.js,Redux.js, Typescript. In the group, my role was to
        ...
        <div className="div-squish"> */}
            <p className="p-projects">
              This website was a one-day group project, and it offers
              information about Indian, Italian, Asian, and Vegan restaurants,
              using CSS3 Javascript, server-side handling. I would like to
              improve this project by adding a 'Search' function.
              <br />
              <a
                className="aa"
